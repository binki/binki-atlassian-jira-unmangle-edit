...
(async () => {
  ...
  if ([...descriptionTextBox.querySelectorAll('a')].find(a => a.href && a.href !== unmangleLink(a.href))) {
    ...
    const descriptionEditorTextArea = await whenElementQuerySelectorAsync(document.body, '[data-testid="issue.views.field.rich-text.editor-container"] #ak-editor-textarea');
    ...
    console.log('description is saving.');
  } else {
